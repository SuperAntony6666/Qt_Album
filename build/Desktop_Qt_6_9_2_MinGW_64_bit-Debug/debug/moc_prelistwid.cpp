...
namespace {
struct qt_meta_tag_ZN10PreListWidE_t {};
} // unnamed namespace

template <> constexpr inline auto PreListWid::qt_create_metaobjectdata<qt_meta_tag_ZN10PreListWidE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'SlotUpSelectItem'
        QtMocHelpers::SlotData<void(QTreeWidgetItem *)>(7, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 5, 6 },
        }}),
    ...
    return QtMocHelpers::metaObjectData<PreListWid, qt_meta_tag_ZN10PreListWidE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject PreListWid::staticMetaObject = { {
    QMetaObject::SuperData::link<QListWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10PreListWidE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10PreListWidE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN10PreListWidE_t>.metaTypes,
    nullptr
} };
...
void PreListWid::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->SlotUpSelectItem((*reinterpret_cast< std::add_pointer_t<QTreeWidgetItem*>>(_a[1]))); break;
        case 3: _t->SlotItemPressed((*reinterpret_cast< std::add_pointer_t<QListWidgetItem*>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (PreListWid::*)(QString )>(_a, &PreListWid::SigUpSelectShow, 0))
            return;
    }
}
...
void *PreListWid::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10PreListWidE_t>.strings))
