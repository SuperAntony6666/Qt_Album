...
template <> constexpr inline auto ProTreeThread::qt_create_metaobjectdata<qt_meta_tag_ZN13ProTreeThreadE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<ProTreeThread, qt_meta_tag_ZN13ProTreeThreadE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject ProTreeThread::staticMetaObject = { {
    QMetaObject::SuperData::link<QThread::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13ProTreeThreadE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13ProTreeThreadE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN13ProTreeThreadE_t>.metaTypes,
    nullptr
} };
...
void ProTreeThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ProTreeThread::*)(int )>(_a, &ProTreeThread::SigUpdateProgress, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (ProTreeThread::*)(int )>(_a, &ProTreeThread::SigFinishProgress, 1))
            return;
    }
}
...
void *ProTreeThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13ProTreeThreadE_t>.strings))
